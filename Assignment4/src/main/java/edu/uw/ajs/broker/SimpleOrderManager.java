...
public class SimpleOrderManager implements OrderManager {
	 ...
	 *            the ticker symbol of the stock this instance is manage orders
	 *            for
	 */
	...
	public SimpleOrderManager(final String stockTickerSymbol, final int price) {
		...
		stopBuyOrderQueue = new SimpleOrderQueue<>("Stop Buy Thread " + threadName, price, (t, o) -> o.getPrice() <= t,
				Comparator.comparing(StopBuyOrder::getPrice).thenComparing(StopBuyOrder::compareTo));
		// Create the stop sell order queue ...
		stopSellOrderQueue = new SimpleOrderQueue<>("Stop Sell Thread " + threadName, price,
				(t, o) -> o.getPrice() >= t,
	...
	/**
	 * Registers the processor to be used during buy order processing. This will
	 * be passed on to the order queues as the dispatch callback.
	 *
	 * @param processor
	 ...
	 * will be passed on to the order queues as the dispatch callback.
	 *
	 * @param processor
	 *            the callback to be registered
	 */
