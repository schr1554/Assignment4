...
public final class SimpleAccountManager implements AccountManager {
	 ...
	 *
	 * @exception AccountException
	 *                if the account already exists, or account creation fails
	 *                for any reason
	 */
	public synchronized Account createAccount(final String accountName, final String password, final int balance)
	 ...
	 *
	 * @throws AccountException
	 *             if the password hashing operation fails
	 */
